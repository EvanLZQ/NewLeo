JAZZMIN_SETTINGS = {
    ...
    "order_with_respect_to": ["auth", "Product", "Customer"],
    ...
    "icons": {
        ...
        "Prescription.PrescriptionPrism": "far fa-eye",
        "Supplier.SupplierInfo": "fas fa-industry"
    },
